...
HD_PWD='D:/capstone/hw_test/hw_test.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_control_led.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source switch_control_led.tcl
