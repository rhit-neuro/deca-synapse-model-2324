...
HD_PWD='D:/capstone/hw_test/hw_test.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log switch_control_led.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source switch_control_led.tcl -notrace
