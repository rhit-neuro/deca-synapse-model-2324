...
HD_PWD='D:/capstone/i2c_reflector/i2c_reflector.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_module.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_module.tcl
