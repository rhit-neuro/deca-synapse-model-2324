...
#
# Script generated by Vivado on Fri Jan 19 16:10:47 -0500 2024
...
#
# Usage        : gpio_test.sh
#                gpio_test.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                gpio_test.sh [-reset_run]
#                gpio_test.sh [-reset_log]
#                gpio_test.sh [-help]
#
...
#                script (type 'gpio_test.sh -help' for more information).
#
...
# script info
echo -e "gpio_test.sh - Script generated by export_simulation (Vivado v2023.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./gpio_test.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"$ref_dir/../../../../arm_gpio.gen/sources_1/bd/gpio_test/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../arm_gpio.gen/sources_1/bd/gpio_test/ipshared/aed8/hdl" +incdir+"../../../../arm_gpio.gen/sources_1/bd/gpio_test/ipshared/ec67/hdl" +incdir+"../../../../arm_gpio.gen/sources_1/bd/gpio_test/ipshared/aed8/hdl" +incdir+"D:/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.gpio_test xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.gpio_test -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log gpio_test_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: gpio_test.sh [-step]\n\
Usage: gpio_test.sh [-lib_map_path]\n\
Usage: gpio_test.sh [-reset_run]\n\
Usage: gpio_test.sh [-reset_log]\n\
Usage: gpio_test.sh [-keep_index]\n\
