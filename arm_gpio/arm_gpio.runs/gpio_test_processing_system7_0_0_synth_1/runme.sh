...
HD_PWD='D:/capstone/arm_gpio/arm_gpio.runs/gpio_test_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gpio_test_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gpio_test_processing_system7_0_0.tcl
