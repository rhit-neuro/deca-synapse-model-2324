...
#
# Script generated by Vivado on Fri Feb 09 00:40:33 -0500 2024
...
design_libs_elab="-libname xilinx_vip -libname xpm -libname blk_mem_gen_v8_4_6 -libname xil_defaultlib -libname xilinx_vip -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xilinx_vip xpm blk_mem_gen_v8_4_6 xil_defaultlib)
...
compile()
{
  xmvlog -work xilinx_vip $xmvlog_opts -sv +incdir+"D:/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"D:/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  ...
  xmvlog -work blk_mem_gen_v8_4_6 $xmvlog_opts +incdir+"D:/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
  "../../../ipstatic/simulation/blk_mem_gen_v8_4.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvlog.log 2>/dev/null

  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"D:/xilinx/Vivado/2023.1/data/xilinx_vip/include" \
