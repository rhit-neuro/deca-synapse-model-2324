...
HD_PWD='D:/capstone/shared_mem/shared_mem.runs/shared_mem_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shared_mem_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shared_mem_axi_smc_0.tcl
