...
HD_PWD='D:/capstone/shared_mem/shared_mem.runs/shared_mem_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shared_mem_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source shared_mem_processing_system7_0_0.tcl
